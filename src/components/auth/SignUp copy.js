...
import { visibilityType, companyType, pageUrl, requiredCountryListForLab } from 'lib/mapper';
  ...
  return (
    <Styled.SignUp data-component-name="SignUp">
      ...
      <Grid container className="signup__form_container">
        ...
        {!!type.value.lab && (
          <>
            <Grid item xs={12}>
              <label className="input__label">
                <T>signup.licenseRegistration</T>
              </label>
            </Grid>
            <Grid item xs={12}>
              <Grid container spacing={1}>
      ...
      <div className="signup__aleady">
        ...
        <T>signup.alreadyAccount</T>
      </div>
      <div className="link__box">
        <Link to={pageUrl.auth.signIn}>
          <T>global.backToLogin</T>
        </Link>
      </div>
    </Styled.SignUp>
  );
